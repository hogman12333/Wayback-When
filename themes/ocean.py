...
input_bg = "#30305080"
input_text = "#e0e0f0"
input_border_color = "#50507080"
input_border_width = "1px"
input_border_radius = "6px"
input_padding = "0px"
input_selection_bg = "#40406080"
input_selection_text = "white"
input_placeholder = "#8080a0"

# --- Buttons ---
button_bg = "#35355580"
button_text = "#ffffff"
button_border_color = "#60608080"
...
# Button States
button_hover_bg = "#45456580"
button_hover_border = "#00d4ff80"
button_pressed_bg = "#25254580"
button_pressed_border = "#00d4ff"
button_disabled_bg = "#30305040"
button_disabled_text = "#606080"
button_disabled_border = "#50507080"

# --- Menu Bar ---
menubar_bg = "#20203580"
menubar_text = "#e0e0f0"
menubar_border = "#50507080"
...
menubar_item_bg_hover = "#40406080"
menubar_item_bg_selected = "#40406080"
menubar_item_text = "#e0e0f0"
menubar_item_text_hover = "#ffffff"
menubar_item_text_selected = "#ffffff"

# --- Dropdown Menus ---
menu_bg = "#2a2a4580"
menu_border = "#50507080"
...
menu_item_bg_hover = "#40406080"
menu_item_bg_selected = "#40406080"
menu_item_text = "#e0e0f0"
menu_item_text_hover = "#ffffff"
menu_item_text_selected = "#ffffff"
menu_separator_color = "#50507080"

# --- Scroll Bars ---
scrollbar_width = "15px"
scrollbar_height = "30px"
scrollbar_bg = "#25254080"
scrollbar_border = "#50507080"
scrollbar_handle_bg = "#40406080"
scrollbar_handle_border_radius = "7px"
scrollbar_handle_min_height = "40px"
scrollbar_handle_min_width = "20px"
scrollbar_handle_hover_bg = "#50507080"
scrollbar_handle_pressed_bg = "#60608080"
scrollbar_add_line = "none"
scrollbar_sub_line = "none"

# --- Progress Bar ---
progressbar_bg = "#25254080"
progressbar_border = "#50507080"
...
# --- Checkboxes/Radios ---
checkbox_bg = "#30305080"
checkbox_border = "#50507080"
...
# --- Sliders ---
slider_groove_bg = "#25254080"
slider_groove_border = "#50507080"
...
def apply(app, widget):
    # --- Palette ---
    palette = QPalette()
    palette.setColor(QPalette.ColorRole.Window, QColor(26, 26, 46, 128))
    palette.setColor(QPalette.ColorRole.WindowText, QColor(224, 224, 240))
    palette.setColor(QPalette.ColorRole.Base, QColor(48, 48, 80, 128))
    palette.setColor(QPalette.ColorRole.AlternateBase, QColor(37, 37, 64, 128))
    palette.setColor(QPalette.ColorRole.ToolTipBase, QColor(42, 42, 69, 128))
    ...
    palette.setColor(QPalette.ColorRole.Button, QColor(53, 53, 85, 128))
    ...
    palette.setColor(QPalette.ColorRole.PlaceholderText, QColor(128, 128, 160))
