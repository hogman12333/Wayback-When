...
# Button States
# button_hover_bg = "#c0e0e8"
# button_hover_border = "#5b9bd5"
# button_pressed_bg = "#b0d8e0"
...
# menubar_item_bg_hover = "#c0e0e8"
# menubar_item_bg_selected = "#c0e0e8"
...
# menu_item_bg_hover = "#c0e0e8"
# menu_item_bg_selected = "#c0e0e8"
...
def apply(app, widget):
    ...
    palette.setColor(QPalette.ColorRole.Button, QColor(208, 232, 240))
