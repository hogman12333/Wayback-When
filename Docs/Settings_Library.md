...
| `archive_timeout_seconds` | int | `1200` | Maximum time (seconds) allowed for a single Wayback Machine save attempt. |
...
| `max_crawler_workers` | int | `20` | Maximum number of concurrent crawler threads. |
