...
class SettingsDialog(QDialog):
    def __init_self, parent=None(self, parent=None):
        super().__init_parent(parent)
...
lambda v, k=key: SETTINGS.__setitem_k, bool(v(k, bool(v))
                )
...
w.setMaximum(10000)
                ...
                w.valueChanged.connect(
                    lambda v, k=key: SETTINGS.__setitem_k, v(k, v)
                )
...
def update_ui_texts(self):
        self.setWindow
Title(self.text_manager.get_text("window_title"))
